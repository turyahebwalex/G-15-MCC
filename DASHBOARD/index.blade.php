<x-layout bodyClass="g-sidenav-show  bg-gray-200">
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">% Question Repetition</p>
                                <h4 class="mb-0">35%</h4>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Overall Performance</p>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">School Rankings</p>
                                <h4 class="mb-0">Kings College</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
            ...
            <div class="row mt-4">
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            <h6 class="mb-0 ">Performance Over Years</h6>
                ...
                <div class="col-lg-4 mt-4 mb-3">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            <h6 class="mb-0 ">Percentage Question Repetition</h6>
                            <!-- <p class="text-sm ">Last Campaign Performance</p> -->
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <!-- <i class="material-icons text-sm my-auto me-1">schedule</i>
    ...
    <script>
        ...
        new Chart(ctx2, {
            type: "line",
            data: {
                labels: ["KAMP", "KCB", "NAM", "", "KINGS", "MACOS", "SMACK", "BUDO", "ST.KIZITO"],
                datasets: [{
                    label: "Position",
                    tension: 0,
                    borderWidth: 0,
                    ...
                    fill: true,
                    data: [10, 100, 35, 22, 60, 25, 40, 30, 80],
                    maxBarThickness: 6
        ...
        new Chart(ctx3, {
            type: "line",
            data: {
                labels: ["QN1", "QN2", "QN3", "QN4", "QN5", "QN6", "QN7", "QN8", "QN9"],
                datasets: [{
                    label: "Repetition%",
                    tension: 0,
                    borderWidth: 0,
                    ...
                    backgroundColor: "transparent",
                    fill: true,
                    data: [10, 40, 35, 22, 100, 25, 40, 30, 100],
                    maxBarThickness: 6
